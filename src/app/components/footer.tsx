...
export default async function Footer() {
  return (
    <footer className=" bottom-0 left-0 w-full">
      <div className=" footer footer-center p-10 bg-secondary text-neutral flex flex-col p-5 text-center">
        ...
        <ul>
          ...
          <li><i className="fa-solid fa-location-dot"></i> 123 Anywhere St., Any City</li>
        </ul>
      </div>
